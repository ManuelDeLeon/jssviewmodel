  ...
  render(){
    <div>
      ...
      <ul>
        ...
        <li><a href='https://facebook.github.io/react/'>React</a> and <a href='https://viewmodel.org'>viewmodel-react</a> for client-side code</li>
        <li><a href='https://webpack.github.io/'>Webpack</a> for building and bundling client-side resources</li>
        <li><a href='http://getbootstrap.com/'>Bootstrap</a> for layout and styling</li>
      </ul>
      <p>To help you get started, we've also set up:</p>
      <ul>
        <li><strong>Client-side navigation</strong>. For example, click <em>MVVM</em> then <em>Back</em> to return here.</li>
        ...
        <li><strong>Lazy load any component</strong>. No need to structure your application around routes. You can defer loading any component with the <code>defer</code> binding.</li>
      </ul>
    </div>
  }
})